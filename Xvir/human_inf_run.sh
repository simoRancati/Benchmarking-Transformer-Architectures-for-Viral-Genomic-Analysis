...
#SBATCH --job-name=xvir_human_preds
...
#SBATCH --output=logs/%j_xvirhuman.log
#SBATCH --error=logs/%j_xvirhuman.log
#SBATCH --gpus=a100:1
##----------------------------------------------------------

DATA_DIR="/blue/simone.marini/share/Embedder_Benchmarking/Data/Illumina_Fasta/illumina_fasta/Human/Illumina/merged_fastas_human"
